...
singularity exec /homes/users/kivankovic/ext-val/epigame.sif /opt/venv/bin/python3 /homes/users/kivankovic/ext-val/scripts/kfold_pairs_ext.py ${SLURM_ARRAY_TASK_ID} "(1,4)"
