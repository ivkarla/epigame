...
singularity exec /homes/users/kivankovic/ext-val/epigame.sif /opt/venv/bin/python3 /homes/users/kivankovic/ext-val/scripts/cvs_game_ext.py ${SLURM_ARRAY_TASK_ID}
